...
@NamedQueries({
    ...
    @NamedQuery(name = "FbsBrokerCat.findByCompanyId", query = "SELECT f FROM FbsBrokerCat f WHERE f.companyId = :companyId"),
...
public class FbsBrokerCat implements Serializable {
    ...
    private Integer bspPercent;
    @Column(name = "BROKER_PERCENT")
    private Integer brokerPercent;
    ...
    public Integer getBspPercent() {
        return bspPercent;
    }

    public void setBspPercent(Integer bspPercent) {
        this.bspPercent = bspPercent;
    }

    public Integer getBrokerPercent() {
        return brokerPercent;
    }

    public void setBrokerPercent(Integer brokerPercent) {
    ...
    public String toString() {
        return "com.smp.entity.FbsBrokerCat[categoryId=" + categoryId + "]";
    }
