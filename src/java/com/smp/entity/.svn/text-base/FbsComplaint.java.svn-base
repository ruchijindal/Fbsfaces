...
@NamedQueries({
    ...
    @NamedQuery(name = "FbsComplaint.findByFkProjId", query = "SELECT f FROM FbsComplaint f WHERE f.fkProjId = :fkProjId"),
...
public class FbsComplaint implements Serializable {
    ...
    public String toString() {
        return "com.smp.entity.FbsComplaint[complaintId=" + complaintId + "]";
    }
