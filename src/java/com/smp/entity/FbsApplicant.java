...
@NamedQueries({
    ...
    @NamedQuery(name = "FbsApplicant.findByFlatId", query = "SELECT f FROM FbsApplicant f WHERE f.flatId = :flatId"),
...
public class FbsApplicant implements Serializable {
    ...
    public Short getApplicantFlag() {
        return applicantFlag;
    }

    public void setApplicantFlag(Short applicantFlag) {
    ...
    public String toString() {
        return "com.smp.entity.FbsApplicant[applicantId=" + applicantId + "]";
    }
